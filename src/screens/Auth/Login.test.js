...
describe('Loging', () => {
    ...
    test('login validation ', async () => {
        ...
        await waitFor(() => {
            expect(getByTestId("login-error-span")).toHaveTextContent("Please enter valid email addres");
        });
        ...
        expect(getByTestId("login-error-span")).toHaveTextContent("Password Required");
    ...
    test('login with credetails ', async () => {
        ...
        const { getByTestId ,queryByTestId} = render(<AuthProvider><Login /></AuthProvider>);
        ...
        await waitFor(() => {
            expect(getByTestId("login-error-span")).toHaveTextContent("Inavlid credetials , Please try again");
        });
